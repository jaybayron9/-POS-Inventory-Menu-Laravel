<nav class="border-b border-gray-300 shadow bg-gray-50" style="background-image: url('{{ asset('storage/eximage/bg3.png') }}'); background-size: 20px 20px;">
    <ul class="overflow-x-auto w-screen flex -mb-px text-sm font-medium text-center text-gray-700">
        ...
        <li class="mr-2">
            <a href="?p=receipts" class="<?= true ? 'font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-gray-900 hover:text-red-800' : ' hover:text-gray-300 hover:border-gray-300 group' ?> inline-flex p-2 border-b-2 border-transparent rounded-t-lg">
        ...
        <li class="mr-2">
            <a href="?p=order" class="<?= true ? 'font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-gray-900 hover:text-red-800' : ' hover:text-gray-300 hover:border-gray-300 group' ?> inline-flex p-2 border-b-2 border-transparent rounded-t-lg relative indicator">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="<?= true ? 'text-rose-600' : 'text-gray-500' ?> w-5 h-5 mr-2">
        ...
        <li class="mr-2">
            <a href="?p=history" class="<?= true ? 'font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-gray-900 hover:text-red-800' : ' hover:text-gray-300 hover:border-gray-300 group' ?> inline-flex p-2 border-b-2 border-transparent rounded-t-lg relative whitespace-nowrap">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="<?= true ? 'text-rose-600' : 'text-gray-500' ?> w-5 h-5 mr-2">
        ...
        <li class="mr-2">
            <a href="?p=product" class="<?= true ||true || true ? 'font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-gray-900 hover:text-red-800' : ' hover:text-gray-300 hover:border-gray-300 group' ?> inline-flex p-2 border-b-2 border-transparent rounded-t-lg">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="<?= true || true || true ? 'text-rose-600' : 'text-gray-500' ?> w-5 h-5 mr-2">
