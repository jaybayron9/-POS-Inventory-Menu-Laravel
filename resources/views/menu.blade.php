<x-layout.app>
    ...
    <section class="pt-5 pb-8 mx-4 grid grid-cols-7 gap-4"> 
        <div id="menu-list" class="col-span-5 mb-6 border border-gray-200 shadow-lg bg-gray-50" data-drawer-hide="drawer-backdrop" aria-controls="drawer-backdrop">
        ...
        <div class="col-span-2 shadow-lg bg-gray-50 border border-gray-200"> 
            <div style="height: 410px" data-drawer-hide="drawer-backdrop" aria-controls="drawer-backdrop"> 
                <table id="menu-table" class="w-full text-sm text-left text-gray-500">
                ...
                <div class="grid grid-cols-3 gap-3">
                    <div>
                        <div id="customer-label">
                            <label class="font-semibold text-xs">Table no.<span class="text-red-500">*</span></label>
                        ...
                        <input type="text" id="customer" name="customer" title="Customer name" maxlength="20" data-row-data="3" class="customer w-full rounded-md border-gray-400 shadow-md py-1" list="tableList">
                    ...
                    <div>
                        ...
                        <textarea type="text" name="" id="note" cols="30" title="Special Request" rows="1" maxlength="75" style="height: 34px;" class="rounded-md overflow-y-hidden w-full border-gray-400 shadow-md py-1"></textarea>
                    </div>
